...
public class RestCliente {
	...
	private String formUrlString = "http://localhost:8065/v1/formulario";
	...
	public void conectarFormREST() throws MalformedURLException, IOException {
		this.connection =  (HttpURLConnection) new URL(this.formUrlString).openConnection();
	}
	...
	public FormularioDTO grabarFormulario(FormularioDTO form) throws MalformedURLException, IOException {
		
		this.url += "save";		
		this.conectarFormREST();
		...
		Gson gson = new Gson();
		String jsonInputString = gson.toJson(form);	
		...
		if(responseCode == HttpURLConnection.HTTP_OK) {
			try(BufferedReader br = new BufferedReader(
				...
				return gson.fromJson(response.toString(),
							new TypeToken<FormularioDTO>() {}.getType()
						);
